  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        const res = await axios.post(`${API_URL}/api/users/signup`, form, {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 to-gray-100 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
        ...
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-[#fe395c]">Airbnb</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-xs text-gray-500">
            ...
            <span className="text-[#fe395c] cursor-pointer">Terms</span> and{" "}
